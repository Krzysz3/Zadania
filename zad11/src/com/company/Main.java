...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Human human_1 = new Human(
                ...
                null,
                6,
                new Car("303", "Maluch", 1.0, new BigDecimal(100000), 2010) {
                    @Override
                    public void refuel() {
                        this.fuel_state =
                                this.fuel_state.add(
        ...
        human_1.setCar(new Car("304", "Maluch", 1.0, new BigDecimal(100000), 2012) {
                           @Override
                           public void refuel() {
                               this.fuel_state =
                                       this.fuel_state.add(
        ...
        Human human_2 = new Human(
                ...
                null,
                6,
                new Car("515", "Ford", 2.0, new BigDecimal(100000), 2008) {
                    @Override
                    public void refuel() {
                        this.fuel_state =
                                this.fuel_state.add(

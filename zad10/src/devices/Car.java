...
public abstract class Car extends Device implements Sellable {
    ...
    public boolean sell(Human seller, Human buyer, BigDecimal price) {
        if (seller.getCar() == null)  {
            System.out.println("On nie ma fury to sciema.");
            return false;
        }
        if (buyer.getMoney() < price.doubleValue()) {
            System.out.println("On nie ma kasy to oszust!.");
            return false;
        }
        ...
        seller.setCar(null);
        System.out.println("Transajca pomiedzy " + seller + " i " + buyer + " zakonczona pomyslnie.");
